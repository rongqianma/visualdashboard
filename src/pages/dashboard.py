...
layout = html.Div(
    ...
    # Dropdown section 
html.Div(
    className='row',  # Added 'row' class to have both elements in the same row
    style={'display': 'flex', 'justifyContent': 'center'},  # Center align the items
    children=[
        html.Div(
            ...
            children=[
                dcc.Dropdown(
                    ...
                    style={**drop_down}  # Adjust width here
                )
            ]
        ),
        html.Div(
...
html.Div(className='row', children=[
       ...
       # html.Div(className='row', children=[
            # Graph 1
            html.Div(className='twelve columns', style={'display': 'inline-block','width':'98%',
                                                    'padding-left': '5px',
                                                    'padding-right': '5px',
                                                      'padding-bottom': '10px'}, children=[
                dcc.Graph(id='histo-chart-final')
            ]),
            # Graph 2
            html.Div(className='twelve columns', style={'padding-left': '5px', 'padding-right': '5px','width':'98%',
...
def update_graph(year_range, selected_journals, selected_keywords):
    ...
    if year_range is None or len(year_range) == 0:
        ...
        fig.update_xaxes(title_text="% of Articles with keyword", tickformat='.2%', 
                         showgrid=True, gridcolor='#404040', griddash='solid')
